...
def get_all_countries(filter_country=[]):
    if filter_country:
        return [{"name":country['name'],"iso3":country['iso3'],"iso2":country['iso2']} for country in ALL_COUNTRIES_AND_ITS_STATE if country['iso3'] in filter_country]
    return [{"name":country['name'],"iso3":country['iso3'],"iso2":country['iso2']}  for country in ALL_COUNTRIES_AND_ITS_STATE]




def get_country_states(filter_country=[]):
    ALL_COUNTRIES_AND_ITS_STATE_DICT = {}
    for k in ALL_COUNTRIES_AND_ITS_STATE:
        if filter_country:
            if k['iso3'] in filter_country:
                ALL_COUNTRIES_AND_ITS_STATE_DICT[k['iso3']] = k['states']
        else:
            ALL_COUNTRIES_AND_ITS_STATE_DICT[k['iso3']] = k['states']
    return ALL_COUNTRIES_AND_ITS_STATE_DICT